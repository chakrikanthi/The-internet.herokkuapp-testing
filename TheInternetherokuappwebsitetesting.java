...
//             true
     ...
     //Entry Ad
		 js.executeScript("document.getElementsByTagName('a')[15].style.border='5px red solid'");
		  ...
		  System.out.println("The entry Ad got closed");
		  driver.navigate().back();
		  js.executeScript("document.getElementsByTagName('a')[15].style.border='5px green solid'");
		 // Output=The entry Ad got closed 
	  
	  	  //Exit Intent-- when ur running this step make sure to keep ur cursor in middle of the screen
		js.executeScript("document.getElementsByTagName('a')[16].style.border='5px red solid'");
		...
		WebElement modalcontainer=mywait.until(ExpectedConditions.visibilityOfElementLocated(By.className("modal-title")));
		WebElement modalcontentbody=driver.findElement(By.xpath(". //div[@class='modal-body']"));
		Assert.assertEquals("It's commonly used to encourage a user to take an action (e.g., give their e-mail address to sign up for something).",modalcontentbody.getText() );
		Thread.sleep(2000);

		WebElement modalclosebutton=modalcontainer.findElement(By.xpath("//p[text()='Close']"));
		modalclosebutton.click();
		Thread.sleep(1000);
		System.out.println("The modal window got closed");
		driver.navigate().back();
		js.executeScript("document.getElementsByTagName('a')[16].style.border='5px green solid'");
		  
		//output:The modal window got closed
...
//				For a definition and common list of HTTP status codes, go here
		...
		driver.findElement(By.xpath("//a[text()='testing.mp3']")).click();
		System.out.println(" testing.mp3 got downloaded");
		driver.navigate().back();
...
//For a definition and common list of HTTP status codes, go here
		...
		//Exit Intent-- when ur running this step make sure to keep ur cursor in middle of the screen
				...
				//robo.mouseMove(0,-100);
				robo1.mouseMove(-100,-100);

				WebDriverWait mywait1=new WebDriverWait(driver,Duration.ofSeconds(30)); 
				WebElement modalcontainer1=mywait1.until(ExpectedConditions.visibilityOfElementLocated(By.className("modal-title")));
				WebElement modalcontentbody1=driver.findElement(By.xpath(". //div[@class='modal-body']"));
				Assert.assertEquals("It's commonly used to encourage a user to take an action (e.g., give their e-mail address to sign up for something).",modalcontentbody1.getText() );
				Thread.sleep(2000);

				WebElement modalclosebutton1=modalcontainer1.findElement(By.xpath("//p[text()='Close']"));
